...
export class ListenerSubsystemServicesApi extends runtime.BaseAPI {
    ...
    async itemPutDcmtkApiV1ListenerListenerObjNameDcmtkPutRaw(requestParameters: ItemPutDcmtkApiV1ListenerListenerObjNameDcmtkPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DcmtkDBReturnModel>> {
        if (requestParameters.listenerObjName === null || requestParameters.listenerObjName === undefined) {
            throw new runtime.RequiredError('listenerObjName','Required parameter requestParameters.listenerObjName was null or undefined when calling itemPutDcmtkApiV1ListenerListenerObjNameDcmtkPut.');
        }

        if (requestParameters.dcmtkDBPutModel === null || requestParameters.dcmtkDBPutModel === undefined) {
            throw new runtime.RequiredError('dcmtkDBPutModel','Required parameter requestParameters.dcmtkDBPutModel was null or undefined when calling itemPutDcmtkApiV1ListenerListenerObjNameDcmtkPut.');
        }
    ...
    async itemPutXinetdApiV1ListenerListenerObjNameXinetdPutRaw(requestParameters: ItemPutXinetdApiV1ListenerListenerObjNameXinetdPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<XinetdDBReturnModel>> {
        if (requestParameters.listenerObjName === null || requestParameters.listenerObjName === undefined) {
            throw new runtime.RequiredError('listenerObjName','Required parameter requestParameters.listenerObjName was null or undefined when calling itemPutXinetdApiV1ListenerListenerObjNameXinetdPut.');
        }

        if (requestParameters.xinetdDBPutModel === null || requestParameters.xinetdDBPutModel === undefined) {
            throw new runtime.RequiredError('xinetdDBPutModel','Required parameter requestParameters.xinetdDBPutModel was null or undefined when calling itemPutXinetdApiV1ListenerListenerObjNameXinetdPut.');
        }
    ...
    async listenerGetApiV1ListenerListenerObjNameGetRaw(requestParameters: ListenerGetApiV1ListenerListenerObjNameGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListenerDBreturnModel>> {
        if (requestParameters.listenerObjName === null || requestParameters.listenerObjName === undefined) {
            throw new runtime.RequiredError('listenerObjName','Required parameter requestParameters.listenerObjName was null or undefined when calling listenerGetApiV1ListenerListenerObjNameGet.');
        }
    ...
    async listenerInitializeApiV1ListenerInitializePostRaw(requestParameters: ListenerInitializeApiV1ListenerInitializePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters.modelsListenerModelValueStr === null || requestParameters.modelsListenerModelValueStr === undefined) {
            throw new runtime.RequiredError('modelsListenerModelValueStr','Required parameter requestParameters.modelsListenerModelValueStr was null or undefined when calling listenerInitializeApiV1ListenerInitializePost.');
        }
    ...
    async listenerStatusGetApiV1ListenerStatusListenerObjNameGetRaw(requestParameters: ListenerStatusGetApiV1ListenerStatusListenerObjNameGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListenerHandlerStatus>> {
        if (requestParameters.listenerObjName === null || requestParameters.listenerObjName === undefined) {
            throw new runtime.RequiredError('listenerObjName','Required parameter requestParameters.listenerObjName was null or undefined when calling listenerStatusGetApiV1ListenerStatusListenerObjNameGet.');
        }
