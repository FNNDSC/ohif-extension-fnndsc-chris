...
export class DicomApi extends runtime.BaseAPI {
    ...
    async readDicomApiV1DicomGetRaw(requestParameters: ReadDicomApiV1DicomGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Dicom>> {
        if (requestParameters.mrn === null || requestParameters.mrn === undefined) {
            throw new runtime.RequiredError('mrn','Required parameter requestParameters.mrn was null or undefined when calling readDicomApiV1DicomGet.');
        }

        const queryParameters: any = {};

        if (requestParameters.mrn !== undefined) {
