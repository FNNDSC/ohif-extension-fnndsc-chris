...
export class PACSSetupServicesApi extends runtime.BaseAPI {
    ...
    async pACSobjPortUpdateApiV1PACSservicePortPostRaw(requestParameters: PACSobjPortUpdateApiV1PACSservicePortPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PACSdbReturnModel>> {
        if (requestParameters.bodyPACSobjPortUpdateApiV1PACSservicePortPost === null || requestParameters.bodyPACSobjPortUpdateApiV1PACSservicePortPost === undefined) {
            throw new runtime.RequiredError('bodyPACSobjPortUpdateApiV1PACSservicePortPost','Required parameter requestParameters.bodyPACSobjPortUpdateApiV1PACSservicePortPost was null or undefined when calling pACSobjPortUpdateApiV1PACSservicePortPost.');
        }
    ...
    async pacsSetupGetApiV1PACSservicePACSobjNameGetRaw(requestParameters: PacsSetupGetApiV1PACSservicePACSobjNameGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PACSdbReturnModel>> {
        if (requestParameters.pACSobjName === null || requestParameters.pACSobjName === undefined) {
            throw new runtime.RequiredError('pACSobjName','Required parameter requestParameters.pACSobjName was null or undefined when calling pacsSetupGetApiV1PACSservicePACSobjNameGet.');
        }
    ...
    async pacsSetupPutApiV1PACSservicePACSobjNamePutRaw(requestParameters: PacsSetupPutApiV1PACSservicePACSobjNamePutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PACSdbReturnModel>> {
        if (requestParameters.pACSobjName === null || requestParameters.pACSobjName === undefined) {
            throw new runtime.RequiredError('pACSobjName','Required parameter requestParameters.pACSobjName was null or undefined when calling pacsSetupPutApiV1PACSservicePACSobjNamePut.');
        }

        if (requestParameters.pACSdbPutModel === null || requestParameters.pACSdbPutModel === undefined) {
            throw new runtime.RequiredError('pACSdbPutModel','Required parameter requestParameters.pACSdbPutModel was null or undefined when calling pacsSetupPutApiV1PACSservicePACSobjNamePut.');
        }
